...
public class DepartmentController extends HttpServlet {
    ...
    /**
     * POST,//49.235.25.9:8080/bysj/department.ctl, 增加学院
    ...
    */
    ...
    /**
     * DELETE,//49.235.25.9:8080/bysj/department.ctl?id=1, 删除id=1的学院
    ...
    /**
     * PUT,49.235.25.9:8080/bysj/department.ctl, 修改学院
     *
    ...
    /**
     * GET,//49.235.25.9:8080/bysj/department.ctl?id=1, 查询id=1的学院
     * GET,//49.235.25.9:8080/bysj/department.ctl, 查询所有的学院
     * 把一个或所有学院对象响应到前端
     * @param request
     * @param response
     * @throws ServletException
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (id_str == null&&school_id==null) {
                responseDepartments(response);
            } else {
                //若school_id = null且id!=null，响应id对应的系对象
                if(school_id==null) {
                    int id = Integer.parseInt(id_str);
                    responseDepartment(id, response);
                }else {
                    //若school_id ！= null且id=null，响应school_id对应的所以系对象
